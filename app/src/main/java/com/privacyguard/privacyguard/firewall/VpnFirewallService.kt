package com.privacyguard.privacyguard.firewall
...
import com.privacyguard.privacyguard.MainActivity
...
class VpnFirewallService : VpnService() {
    ...
    companion object {
        const val ACTION_START_OR_UPDATE = "com.privacyguard.privacyguard.firewall.START"
        const val ACTION_STOP = "com.privacyguard.privacyguard.firewall.STOP"
